function AboutMeInfo() {
  ...
  return (
    <div className="w-5/6 flex flex-col items-start text-left pl-12  max-sm:p-0 max-sm:m-0">
      <h5 className="m-0 p-0 text-cyan-800 text-lg font-bold pt-2 max-sm:text-left">
        ABOUT ME
      </h5>
      <h4 className="m-0 p-0 pt-1 font-semibold text-xl max-sm:text-left">
        {heading}
      </h4>
      <p className="m-0 p-0 pt-2 text-sm max-sm:text-left">{info}</p>
    </div>
  );
}
